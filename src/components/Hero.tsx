...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative pt-44 bg-white"
    ...
    >
      ...
      <div ref={ref} className="reveal relative z-10 max-w-4xl mx-auto px-6 text-center">
        <h1 className="text-[64px] font-medium text-foreground leading-[1.05] tracking-[-0.02em] mb-6">
          Conectando
          <br />
          seu tempo ao futuro
        </h1>

        <p className="text-foreground/60 text-[18px] font-[family-name:var(--font-geist-sans)] max-w-xl mx-auto leading-relaxed mb-24">
      ...
      <div className="reveal-slow max-w-[1200px] mx-auto px-6 relative z-10 -mb-16 md:-mb-32">
        <div
